...
SubShader {
	...
	Pass {
		...
		half4 raymarching(pixel_t input)
		{
			half d = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, input.texcoord0).a;
		...
		float4 PixShader(pixel_t input) : SV_Target
		{
			...
			// return SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, input.texcoord0).aaaa;
